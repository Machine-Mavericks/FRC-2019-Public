...
DriverOI::DriverOI() {
    ...
    LeftJoystickButton1->WhileHeld(new DriveGoToTarget());
    ...
    ////////////////////// TEMPORARY /////////////////////////////
    // for testing only
    LeftJoystickButton4->WhenPressed(new DriveStraightDistance(60.0, 0.20)); //DriveTurnToAngle(90.0, 0.25));
    LeftJoystickButton6->WhenPressed(new DriveTurnToAngle(-90.0, 0.25 )); //DriveStraightDistance(36.0, 0.20));
    ////////////////////////////////
