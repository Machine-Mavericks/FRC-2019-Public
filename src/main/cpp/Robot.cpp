...
void Robot::RobotPeriodic() {
  frc::SmartDashboard::PutNumber("Left Encoder", m_MainDrive.GetLeftEncoderDistance());
  frc::SmartDashboard::PutNumber("Right Encoder", m_MainDrive.GetRightEncoderDistance());
