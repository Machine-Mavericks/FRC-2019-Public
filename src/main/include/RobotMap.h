...
#define ELEVATOR_PGAIN                 0.5 //  0.6 // 0.2 // 0.2
#define ELEVATOR_IGAIN                0.004 // 0  //0.0005 // 0.0002    
#define ELEVATOR_DGAIN                 20.0  // 0.1 // 0.1         
...
#define TILT_DOWN_POSITION             1023 //8000 

// Elevator position control error gains
#define TILT_PGAIN                  0.8 // 0.2
#define TILT_IGAIN                  0.0002  // Note: I gain should be used very sparingly. 
#define TILT_DGAIN                  0.01         
