...
#define ELEVATOR_POSITION1              7300
#define ELEVATOR_POSITION2              13000
#define ELEVATOR_POSITION3              38300
#define ELEVATOR_POSITION4              43600
...
#define TILT_ENCODER_PULSE_PER_REVOLUTION   4096
    ...
    #define TILT_PGAIN                      3.0     // 1.0 Feb 18 2019
    #define TILT_IGAIN                      0.02  // 0.02: div 10 Feb 17
    #define TILT_DGAIN                      0.1   
#endif
    ...
    // motor current limit
    #define TILT_CURRENT_LIMIT              4
    #define TILT_PEAKCURRENT_LIMIT          8
    #define TILT_PEAKCURRENT_TIME           2

    // Tilt position control error gains
    #define TILT_PGAIN                      0.5
    #define TILT_IGAIN                      0.00015
...
#define TILT_DOWN_POSITION              1090  // Feb 18 1100 // 1023 Feb 17 // 1100 Feb 18
   
// Elevator positional tolerance. Elevator reports to driverstation if position if within +/- tolerance of target position
#define TILT_POSITION_TOLERANCE         100

#define TILT_MAX_INTEGRAL_ACCUMULATOR   4000  // Feb 18 2000
...
// claw current limit (A)
#define SNOWBLOWER_CURRENT_LIMIT_IN     1.5
