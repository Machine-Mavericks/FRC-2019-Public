...
#define ELEVATOR_POSITION1              1000
#define ELEVATOR_POSITION2              2000
#define ELEVATOR_POSITION3              3000
#define ELEVATOR_POSITION4              5000
...
// Motor encoder counts per revolution
// TalonSRX uses 4x count mode - encoder normally has 1024 pulses per revolution
#define CLAW_ENCODER_PULSE_PER_REVOLUTION   4096

// claw current limit
#define CLAW_CURRENT_LIMIT          3
...
#define TILT_IGAIN                  0.0001 //0.0005 // 0.0002  // Note: I gain should be used very sparingly. 
#define TILT_DGAIN                  40 // 0.01         
