...
class Limelight : public frc::Subsystem {
    ...
    double GetRawScreenspaceX0();
    double GetRawScreenspaceX1();
    double GetRawScreenspaceX2();
    double GetRawScreenspaceY0();
    double GetRawScreenspaceY1();
    double GetRawScreenspaceY2();
    double GetRawArea0();
    double GetRawArea1();
    double GetRawArea2();
    double GetRawSkew0();
